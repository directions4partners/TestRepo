...
$GitHubHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/freddydk/AL-Go/main/Actions/Github-Helper.psm1' -folder $tmpFolder -notifyAuthenticatedAttempt
$ReadSettingsModule = DownloadHelperFile -url 'https://raw.githubusercontent.com/freddydk/AL-Go/main/Actions/.Modules/ReadSettings.psm1' -folder $tmpFolder
$debugLoggingModule = DownloadHelperFile -url 'https://raw.githubusercontent.com/freddydk/AL-Go/main/Actions/.Modules/DebugLogHelper.psm1' -folder $tmpFolder
...
DownloadHelperFile -url 'https://raw.githubusercontent.com/freddydk/AL-Go/main/Actions/.Modules/settings.schema.json' -folder $tmpFolder | Out-Null
DownloadHelperFile -url 'https://raw.githubusercontent.com/freddydk/AL-Go/main/Actions/Environment.Packages.proj' -folder $tmpFolder | Out-Null
